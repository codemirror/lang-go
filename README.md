...
[ [**WEBSITE**](https://codemirror.net/) | [**ISSUES**](https://code.haverbeke.berlin/codemirror/dev/issues) | [**FORUM**](https://discuss.codemirror.net/) | [**CHANGELOG**](https://code.haverbeke.berlin/codemirror/lang-go/src/branch/main/CHANGELOG.md) ]
...
[MIT license](https://code.haverbeke.berlin/codemirror/lang-go/tree/main/LICENSE).
...
<dd><p>A language provider based on the <a href="https://code.haverbeke.berlin/lezer/go">Lezer Go
